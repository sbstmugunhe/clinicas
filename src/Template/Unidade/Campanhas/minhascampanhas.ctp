    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('List of') ?> Campanhas</h3>
          <div class="box-tools">
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th><?= $this->Paginator->sort('tipo_vacinacao') ?></th>
                <th><?= $this->Paginator->sort('dose') ?></th>
                <th><?= $this->Paginator->sort('unidade_sanitaria') ?></th>
                <th><?= $this->Paginator->sort('brigada_movel') ?></th>
                <th><?= __('Actions') ?></th>
              </tr>
            </thead>
            <tbody>
            <?php foreach ($campanhas as $campanha): ?>
              <tr>
                ...
                <td class="actions" style="white-space:nowrap">
                  ...
                  <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $campanha->id], ['confirm' => __('Confirm to delete this entry?'), 'class'=>'btn btn-danger btn-xs']) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
